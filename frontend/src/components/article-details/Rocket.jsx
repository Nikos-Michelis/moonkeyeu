...
const Rocket = ({name, variant, fullname, active,
    ...
    return(
        <section className="rocket-section">
            ...
            <div className="container flex flex-wrap justify-center align-center padding-block-8" data-type="full-bleed" data-spacing="none">
                <div className="img-box container flex flex-column justify-center margin-block-start-5" data-type="full-bleed">
                    <Img
                    ...
                    <div className="flex flex-wrap">
                        <div className="badge badge-pill">Configuration: {checkValue(variant)}</div>
                        <div className="badge badge-pill">Maiden Flight: {checkValue(maiden_flight)}</div>
                        { active
                            ?
                            <div className="badge badge-pill bg-success-400">Active</div>
                            :
                            <div className="badge badge-pill bg-warning-200">Retired</div>}
                    </div>
                </div>
                ...
                <div className="container __rocket-info flex flex-wrap margin-block-2" data-type="full-bleed">
