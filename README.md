...
---
# 🗂️ Repositories
The project is maintained in separate repositories. You can find both of them here:
- 🌱️ [**Backend**](https://github.com/Nikos-Michelis/moonkeyeu-backend)
- ⚛️ [**Frontend**](https://github.com/Nikos-Michelis/moonkeyeu-frontend)
...
**Backend and Frontend Installation:** Setup instructions for the backend can be found in the [`backend/README.md`](https://github.com/Nikos-Michelis/moonkeyeu-backend) file, and for the frontend in the [`frontend/README.md`](https://github.com/Nikos-Michelis/moonkeyeu-frontend) file.
